package com.hyperion.grabber.mobile;
...
public class HyperionGrabberTileService extends TileService {
    ...
    private boolean startSetupIfNeeded(){
        ...
        if (TextUtils.isEmpty(preferences.getString(com.hyperion.grabber.common.R.string.pref_key_host, null)) || preferences.getInt(com.hyperion.grabber.common.R.string.pref_key_port, -1) == -1){
