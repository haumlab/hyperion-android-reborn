...
public class HyperionGrabberTileService extends TileService {
    ...
    private boolean startSetupIfNeeded(){
        ...
        if (TextUtils.isEmpty(preferences.getString(com.abrenoch.hyperiongrabber.common.R.string.pref_key_host, null)) || preferences.getInt(com.abrenoch.hyperiongrabber.common.R.string.pref_key_port, -1) == -1){
