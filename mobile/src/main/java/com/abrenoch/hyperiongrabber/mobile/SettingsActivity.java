...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = (preference, value) -> {
        final int prefResourceID = getResourceId(preference.getKey(), com.abrenoch.hyperiongrabber.common.R.string.class);
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(com.abrenoch.hyperiongrabber.common.R.xml.pref_general);
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(getString(com.abrenoch.hyperiongrabber.common.R.string.pref_key_host)));
            bindPreferenceSummaryToValue(findPreference(getString(com.abrenoch.hyperiongrabber.common.R.string.pref_key_port)));
            bindPreferenceSummaryToValue(findPreference(getString(com.abrenoch.hyperiongrabber.common.R.string.pref_key_priority)));
            bindPreferenceSummaryToValue(findPreference(getString(com.abrenoch.hyperiongrabber.common.R.string.pref_key_framerate)));
            bindPreferenceSummaryToValue(findPreference(getString(com.abrenoch.hyperiongrabber.common.R.string.pref_key_reconnect_delay)));
            bindPreferenceSummaryToValue(findPreference(getString(com.abrenoch.hyperiongrabber.common.R.string.pref_key_x_led)));
            bindPreferenceSummaryToValue(findPreference(getString(com.abrenoch.hyperiongrabber.common.R.string.pref_key_y_led)));
        }
