...
public class HyperionGrabberOptions {
    ...
    private final int CAPTURE_QUALITY;
    private final int BLACK_THRESHOLD = 5; // The limit each RGB value must be under to be considered a black pixel [0-255]

    public HyperionGrabberOptions(int horizontalLED, int verticalLED, int frameRate, boolean useAvgColor, int captureQuality) {
    ...
    public int getCaptureQuality() { return CAPTURE_QUALITY; }
