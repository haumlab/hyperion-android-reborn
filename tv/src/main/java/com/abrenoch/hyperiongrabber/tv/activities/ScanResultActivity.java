...
public class ScanResultActivity extends LeanbackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String partyPopper = "\uD83C\uDF89";
        descriptionText.setText(getResources().getString(com.abrenoch.hyperiongrabber.common.R.string.scan_result_description, partyPopper));
        ...
        if (extras != null){
            ...
            hostNameText.setText(com.abrenoch.hyperiongrabber.common.R.string.error_no_host_name_extra);
        }
