...
public class MainActivity extends LeanbackActivity implements ImageView.OnClickListener,
    ...
    private boolean initIfConfigured() {
        ...
        String host = preferences.getString(com.abrenoch.hyperiongrabber.common.R.string.pref_key_host, null);
        int port = preferences.getInt(com.abrenoch.hyperiongrabber.common.R.string.pref_key_port, -1);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_MEDIA_PROJECTION) {
            if (resultCode != Activity.RESULT_OK) {
                Toast.makeText(this, com.abrenoch.hyperiongrabber.common.R.string.toast_must_give_permission, Toast.LENGTH_SHORT).show();
                if (mRecorderRunning) {
                    stopScreenRecorder();
                }
